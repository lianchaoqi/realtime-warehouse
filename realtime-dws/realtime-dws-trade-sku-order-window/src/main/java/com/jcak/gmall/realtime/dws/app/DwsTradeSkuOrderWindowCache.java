 ...
 * @Version: jdk1.8
 */
public class DwsTradeSkuOrderWindowCache extends BaseApp {
    public static void main(String[] args) {
        new DwsTradeSkuOrderWindowCache().start(11010, 2, "DwdTradeSkuOrderWindow1", Constant.TOPIC_DWD_TRADE_ORDER_DETAIL);
    }
    ...
    public void handle(StreamExecutionEnvironment env, DataStreamSource<String> stream) {
        ...
        //旁路缓存关联
        SingleOutputStreamOperator<TradeSkuOrderBean> map =
                reduceStream.map(new RedisGetRichMapfunction());
//        写出到doris
//        res.map(
