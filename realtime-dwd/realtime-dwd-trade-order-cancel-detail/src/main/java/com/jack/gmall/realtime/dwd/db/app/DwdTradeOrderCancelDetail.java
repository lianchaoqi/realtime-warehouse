...
public class DwdTradeOrderCancelDetail extends BaseSQLApp {
    ...
    public void handle(StreamExecutionEnvironment env, StreamTableEnvironment tableEnv, String ckAndGroupId) {
        ...
        // 1. 读取 topic_db 数据
        createKafkaTopicDBTab(Constant.TOPIC_DWD_TRADE_ORDER_CANCEL,tableEnv);
        // 2. 读取 dwd 层下单事务事实表数据
        tableEnv.executeSql(
                "create table dwd_trade_order_detail(" +
                        ...
                        "ts bigint " +
                        ")" + FlinkSQLUtil.getKafkaSourcePreStr(Constant.TOPIC_DWD_TRADE_ORDER_DETAIL,Constant.TOPIC_DWD_TRADE_ORDER_CANCEL));
        ...
        tableEnv.executeSql(
                "create table dwd_trade_order_cancel_detail(" +
                        ...
                        "split_total_amount string," +
                        "ts bigint " +
                        ")" + FlinkSQLUtil.getKafkaDDLSink(Constant.TOPIC_DWD_TRADE_ORDER_CANCEL));
